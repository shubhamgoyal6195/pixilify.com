...
// ✅ Import your new viewer component (uses @react-pdf-viewer/core)
...
export default function PdftoImages() {
    ...
    // ✅ Load pdfjs-dist only for conversion (not for preview)
    useEffect(() => {
    ...
    // ✅ PDF → Image conversion (still uses pdfjs-dist)
    const handleConvert = async () => {
        if (!pdfFile || !pdfjsAssets) return;
        ...
        try {
            ...
            const pdfDocument = await pdfjsAssets.getDocument({ data: arrayBuffer }).promise;
            ...
            for (let i = 1; i <= numPages; i++) {
                ...
                const filename = `${pdfFile.name.replace(/\.pdf$/i, '')}_page_${i}.${imageFormat}`;
            ...
            <div className="max-w-6xl mx-auto p-8">
                <div className="flex justify-center py-12">
                    <label className="flex flex-col items-center justify-center w-full max-w-4xl h-48 border-4 border-dashed rounded-md cursor-pointer bg-blue-100 transition duration-300 border-blue-400 shadow-lg hover:bg-blue-200">
                        ...
                        <input type="file" className="hidden" accept="application/pdf" onChange={onFileChange} ref={fileInputRef} />
                    </label>
                </div>
            </div>
            <footer className="p-8 mt-12 bg-gray-50 rounded-lg shadow-inner">
                <p className="text-gray-600 mb-3">Pixilify's <strong>PDF to Image Tool</strong> works entirely <strong>in your browser</strong> for full privacy.</p>
            </footer>
        </div>
    );
            ...
            <div className="max-w-7xl w-full flex flex-col md:flex-row gap-6">
                <div className="flex-grow flex flex-col p-6">
                    <div className="flex justify-between w-full mb-4">
                        <h2 className="text-xl md:text-2xl font-bold text-gray-800">PDF Ready for Conversion</h2>
                        <button
                            onClick={removeFile}
                    ...
                    <div className="w-full min-h-[400px] p-8 bg-white border border-gray-200 rounded-lg shadow-inner flex flex-col items-center justify-center">
                        {pdfFile ? (
                            <PdfViewer fileUrl={URL.createObjectURL(pdfFile.file)} />
                        ) : (
                ...
                <div className="md:w-80 flex-shrink-0 p-6 bg-white border rounded-xl shadow-lg self-stretch flex flex-col relative">
                    <h3 className="text-xl font-semibold mb-4 text-gray-800 border-b pb-2">Conversion Settings</h3>
                    ...
                    <div className="flex-grow space-y-4">
                        <div>
                            ...
                            <select
                                ...
                                className="mt-1 block w-full pl-3 pr-10 py-2 border-gray-300 focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 block w-full pl-3 pr-3 py-2 border-gray-300 focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                            />
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-200">
                        <button
                            ...
                            disabled={!pdfFile || isProcessing || !pdfjsAssets}
    ...
    const ResultScreen = ({ convertedImages, onBack, onConvertAgain }) => (
        <div className="flex flex-col items-center justify-start p-8 min-h-[500px] bg-gray-50">
            <div className="max-w-4xl w-full text-center py-12">
                <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-6">PDF converted to Images!</h1>

                {convertedImages.length > 0 && (
                    <div className="max-w-4xl w-full mt-8 p-8 bg-white border border-gray-200 rounded-lg shadow-lg mx-auto">
                        <h2 className="text-xl font-semibold text-gray-700 mb-4 border-b pb-2">Your Images</h2>
